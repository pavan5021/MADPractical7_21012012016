package com.example.madpractical7_21012012016
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val CancleAlarmCardView = findViewById<MaterialCardView>(R.id.remove_alram)
        val BtnCreateAlarm = findViewById<MaterialButton>(R.id.create_alaram)
        val SetAlarmTime = findViewById<TextView>(R.id.time)
        val BtnCancelAlarm = findViewById<MaterialButton>(R.id.remove)
        val clockTC = findViewById<TextClock>(R.id.clock_text)
